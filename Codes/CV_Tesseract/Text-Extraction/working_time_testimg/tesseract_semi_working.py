...
# Load the image
filepath = "D:/AJAYMON/AJAY/Programming/Auto_Excel_Mark_Entry/Codes/CV_Tesseract/Text-Extraction-Table-Image_workOnThis/images/abdul.jpg"
img = cv2.imread(filepath)
image = cv2.resize(img, (650,750), interpolation = cv2.INTER_AREA)
# Identify the ROIs
rois = [(69, 413, 529, 208)] # ROI coordinates
